...
class Cube(nn.Module):
    ...
    def forward(self, input_equi_image, input_cube_image, dnet=False):
        ...
        equi_x = upsample(self.equi_dec_convs["upconv_5"](c2e_enc_feat4))
        ...
        equi_x = torch.cat([equi_x, c2e_enc_feat3], 1)
        ...
        equi_x = torch.cat([equi_x, c2e_enc_feat2], 1)
        ...
        equi_x = torch.cat([equi_x, c2e_enc_feat1], 1)
