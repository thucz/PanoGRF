...
database_name="m3d"
total_step=20000 #100000
name="neuray_gen_erp_1.0_mono_stereo_uniform_512x1024_mv_v4_50000-"$total_step
# data_cnt=5 
...
# do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=0 python render_mv.py --cfg configs/train/gen_hr_1.0/neuray_gen_cv_erp_mono_stereo_uniform_512x1024_mv_v4.yaml \
