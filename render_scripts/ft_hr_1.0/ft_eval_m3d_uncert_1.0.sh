...
# do
    ...
    # do
        num=0;
        name="neuray_ft_m3d_diff_uncert_mono_uniform_hr_id_$num-10000"
        CUDA_VISIBLE_DEVICES=0 python render.py --cfg configs/train/ft_hr_1.0/neuray_ft_cv_m3d_diff_uncert_mono_uniform.yaml \
