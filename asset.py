...
# if os.path.exists(data_dir+'/google_scanned_objects'):
#     for fn in os.listdir(data_dir+'/google_scanned_objects'):
#         if os.path.isdir(os.path.join(data_dir+'/google_scanned_objects',fn)):
...
# if os.path.exists(data_dir+'/dtu_train') and os.path.exists(data_dir+'/dtu_test'):
#     fns = os.listdir(data_dir+'/dtu_train')
#     fns = [fn for fn in fns if fn.startswith('scan')]
#     test_scenes = os.listdir(data_dir+'/dtu_test')
...
# if os.path.exists(data_dir+'/real_iconic_noface'):
#     fns = os.listdir(data_dir+'/real_iconic_noface')
#     real_iconic_scene_names_8 = [f'real_iconic/{fn}/8' for fn in fns]
#     real_iconic_scene_names_4 = [f'real_iconic/{fn}/4' for fn in fns]

# space_scene_names = []
# if os.path.exists(data_dir+'/spaces_dataset'):
#     fns = os.listdir(data_dir+'/spaces_dataset/data/800')
#     space_scene_names = [f'space/{fn}' for fn in fns]

# real_estate_scene_names = []
# if os.path.exists(data_dir+'/real_estate_dataset'):
#     fns = os.listdir(data_dir+'/real_estate_dataset/train/frames')
...
# LLFF_ROOT = data_dir+'/llff_colmap'

# NERF_SYN_ROOT = data_dir+'/nerf_synthetic'